...
export const CHAPTERS = [
  ...
  },
  {
    ...
    quests: [
      ...
      { id: "s7", n: 13, title: "Klik op die sirkeldeel", blurb: "Klik op die koord, middelpunt of boog.", built: true },
      { id: "s7b", n: 14, title: "Klik op die sirkeldeel — Deel 2", blurb: "Nou uit 'n beskrywing, nie 'n naam nie.", built: true },
