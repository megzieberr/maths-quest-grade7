...
export const CHAPTERS = [
  ...
  },
  {
    ...
    quests: [
      ...
      { id: "st13", n: 13, title: "Leer: Binnehoeke van 'n driehoek", blurb: "Hulle tel altyd op tot 180°.", built: false },
      { id: "st14", n: 14, title: "Binnehoeke: bereken", blurb: "Gebruik die rede, bereken x.", built: false },
      { id: "st15", n: 15, title: "Binnehoeke: kies die rede", blurb: "Die waarde is gegee — hoekom?", built: false },
      { id: "st16", n: 16, title: "Binnehoeke: waarde én rede", blurb: "Tik die waarde EN kies die rede.", built: false },
      { id: "st17", n: 17, title: "Leer: Gelykbenige driehoek", blurb: "Hoeke oor gelyke sye is gelyk.", built: false },
      { id: "st18", n: 18, title: "Gelykbenig: tophoek gegee", blurb: "Minus eerste, dan deel deur 2.", built: false },
      { id: "st19", n: 19, title: "Gelykbenig: basishoek gegee", blurb: "Die ander basishoek is net gelyk.", built: false },
      { id: "st20", n: 20, title: "Deel jy deur 2?", blurb: "Yay of Nay — wanneer deel jy?", built: false },
      { id: "st21", n: 21, title: "Gelykbenig: kies die rede", blurb: "Die waarde is gegee — hoekom?", built: false },
      { id: "st22", n: 22, title: "Gelykbenig: waarde én rede", blurb: "Tik die waarde EN kies die rede.", built: false },
      { id: "st23", n: 23, title: "Leer: Buitehoek van 'n driehoek", blurb: "Buite = som van die 2 ver hoeke.", built: false },
      { id: "st24", n: 24, title: "Binne of buite?", blurb: "Watter tipe hoek is gemerk?", built: false },
      { id: "st25", n: 25, title: "Buitehoek: bereken", blurb: "Gebruik die rede, bereken x.", built: false },
      { id: "st26", n: 26, title: "Buitehoek: kies die rede", blurb: "Die waarde is gegee — hoekom?", built: false },
      { id: "st27", n: 27, title: "Buitehoek: waarde én rede", blurb: "Tik die waarde EN kies die rede.", built: false },
      { id: "st28", n: 28, title: "Gemeng: bereken die waarde", blurb: "Al ses stellings deurmekaar.", built: false },
      { id: "st29", n: 29, title: "Gemeng: kies die rede", blurb: "Al ses stellings deurmekaar.", built: false },
      { id: "st30", n: 30, title: "Gemeng: waarde én rede (1)", blurb: "Al ses stellings deurmekaar.", built: false },
      { id: "st31", n: 31, title: "Gemeng: waarde én rede (2)", blurb: "Al ses stellings deurmekaar.", built: false },
      { id: "st32", n: 32, title: "Groot Gemeng — wys wat jy weet!", blurb: "Twee-stap vrae, steeds maklik.", built: false },
    ],
  },
];
