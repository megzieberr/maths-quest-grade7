...
export const CHAPTERS = [
  ...
  },
  {
    ...
    quests: [
      ...
      { id: "m2", n: 3, title: "Soorte hoeke", blurb: "Skerp, reg, stomp of gestrek?", built: true },
      { id: "m2b", n: 4, title: "Soorte hoeke — Deel 2", blurb: "Waar of onwaar — is die bewering reg?", built: true },
      { id: "m3", n: 5, title: "Lyne & notasie", blurb: "Parallel, loodreg en die simbole.", built: true },
      { id: "m3b", n: 6, title: "Lyne & notasie — Deel 2", blurb: "Spoorlyne, mure en vloere — kies die voorbeelde.", built: true },
      { id: "m4", n: 7, title: "Punte & lyne", blurb: "Punt, lyn, straal, lynsegment of snylyn?", built: true },
      { id: "m4b", n: 8, title: "Punte & lyne — Deel 2", blurb: "Lees die beskrywing, kies die naam.", built: true },
      { id: "m5", n: 9, title: "Komplementêre hoeke", blurb: "Twee hoeke maak saam 90°.", built: true },
      { id: "m5b", n: 10, title: "Komplementêre hoeke — Deel 2", blurb: "Waar of onwaar — tel dit op tot 90°?", built: true },
      { id: "m6", n: 11, title: "Supplementêre hoeke", blurb: "Twee hoeke maak saam 180°.", built: true },
      { id: "m6b", n: 12, title: "Supplementêre hoeke — Deel 2", blurb: "Waar of onwaar — tel dit op tot 180°?", built: true },
      { id: "m7", n: 13, title: "Hoeke op 'n reguitlyn", blurb: "Die hoeke tel saam tot 180°.", built: true },
      { id: "m7b", n: 14, title: "Hoeke op 'n reguitlyn — Deel 2", blurb: "Gaan iemand anders se antwoord na.", built: true },
      { id: "m8", n: 15, title: "Hoeke rondom 'n punt", blurb: "Al die hoeke tel saam tot 360°.", built: true },
      { id: "m8b", n: 16, title: "Hoeke rondom 'n punt — Deel 2", blurb: "Gaan iemand anders se antwoord na.", built: true },
      { id: "m9", n: 17, title: "Regoorstaande hoeke", blurb: "Waar twee lyne sny — gelyke hoeke.", built: true },
      { id: "m9b", n: 18, title: "Regoorstaande hoeke — Deel 2", blurb: "Gaan iemand anders se antwoord na.", built: true },
      { id: "m10", n: 19, title: "Inspringende (refleks) hoeke", blurb: "Trek die kleiner hoek van 360° af.", built: true },
      { id: "m10b", n: 20, title: "Inspringende (refleks) hoeke — Deel 2", blurb: "Gaan iemand anders se antwoord na.", built: true },
    ],
  },
  {
